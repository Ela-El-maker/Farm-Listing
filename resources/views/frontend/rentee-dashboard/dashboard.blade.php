        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                    ...
                    <div class="col-lg-4">
                        <div class="dashboard-card dashboard-card--count bgcolor--primary-9">
                            <div class="dashboard-card--count__info">
                                ...
                                <h2 class="counter-title text--body-3">Posted Ads</h2>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="dashboard-card dashboard-card--count bgcolor--success-9">
                            <div class="dashboard-card--count__info">
                                ...
                                <h2 class="counter-title text--body-3">Favourite Ads</h2>
                            </div>
                            <div class="dashboard-card--count__icon">
                                <span class="icon">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-6">
                        <div class="dashboard-card">
                            <div class="dashboard__section-info">
                                <h2 class="dashboard-card__title">Ads View</h2>
                        ...
                        <div class="dashboard-card dashboard-card--recent">
                            ...
                            <ul class="dashboard-card--recent__activity">
                                <li class="dashboard-card--recent__activity-item success">
                                    ...
                                    <p class="text--body-3">Your ad <span class="quote">“v21 48mp ois slefie”</span> is successful published. <a href="#">View ad</a></p>
                                </li>
                                ...
                                <li class="dashboard-card--recent__activity-item success">
                                    ...
                                    <p class="text--body-3">Your ad <span class="quote">“converse blue training shoes”</span> is successful published. <a href="#">View ad</a></p>
                                </li>
                ...
                <div class="dashboard__posted-ads">
                    <div class="dashboard__section-info">
                        <h2 class="dashboard-card__title">Recently Posted Ads</h2>
