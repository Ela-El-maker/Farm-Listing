            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false"> <i class="fa fa-location-arrow"></i> Locations</a>
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-puzzle-piece"></i><a href="{{ route('admin.countries.index') }}">Country</a></li>
                        <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">State</a></li>
                        <li><i class="fa fa-bars"></i><a href="ui-tabs.html">City</a></li>
                    </ul>
                </li>
