                    ...
                    <div class="registration__features">
                        <div class="registration__features-item">
                            ...
                            <div class="registration__features-info">
                                ...
                                <p class="text--body-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
                        ...
                        <div class="registration__features-item">
                            ...
                            <div class="registration__features-info">
                                ...
                                <p class="text--body-3">Class aptent taciti sociosqu ad litora torquent per conubia nostra,
                    ...
                    <div class="registration-form">
                        ...
                        <div class="registration-form__wrapper">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <p class="text--body-3 registration-form__redirect">Don't Have Account ? <a
